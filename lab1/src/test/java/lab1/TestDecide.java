...
public class TestDecide {
	...
	public void LIC9test() {
		double[] LIC9Truex = new double[] {0, 4, 9, 19, 0, 14, 15};
		double[] LIC9Truey = new double[] {0, 4, 9, 19, 0, 14, 15};
		Decide decide = new Decide();
		decide.parameters.epsilon = 3;
		decide.parameters.cPts = 1; // 0 - 9 - 15
		decide.parameters.cPts = 3;
		decide.parameters.epsilon = 3;
		decide.numpoints = 7;
